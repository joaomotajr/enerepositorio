package br.com.eneeyes.main.model.historic.day;
...
@Entity
@Subselect("select * from historic_a_day_view")
public class HistoricADayView implements IHistoricGroup {

    public HistoricADayView() {
