									...
									<div class="row">
										...
										<div class="col-md-6">
											...
											<div class="box box-primary collapsed-box">
												<div class="box-header with-border">
													<Label class="box-title">{{selectedCompanyDetector.detectorDto.name}} - {{selectedCompanyDetector.detectorDto.model}}</label>
											...
											<div class="panel-body">							            					                 										                	
												<div class="row">
													<div class="col-md-6">
														...
														<span class="pull-left text-black" title="{{item.name}}" data-ng-if="item.alarmOn==false"><i class="fa-lg fa fa-bell-slash" title="Alarm Off"></i></span>
														<span class="pull-left text-navy" title="{{item.name}}" data-ng-if="item.alarmOn==true"><i class="fa-lg fa fa-bell" title=" Alarm On"></i></span>
													</div>
													<div class="col-md-6">
												...
												<ul class="list-group">																		
													...
													<span data-ng-if="item.alarmOn">
														<li class="list-group-item" style="padding: 0px 15px;">
															<label>Alarme Atribu&iacute;do:</label><span class="pull-right">{{item.name}}</span> 
														</li>
