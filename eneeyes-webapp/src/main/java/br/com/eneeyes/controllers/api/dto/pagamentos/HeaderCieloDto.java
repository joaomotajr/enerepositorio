...
public class HeaderCieloDto implements Serializable {
	...
	public HeaderCieloDto() {
	}
	
	public HeaderCieloDto(Integer tipoRegistro, Integer estabelecimentoMatriz, Date dataProcessamento,
			Date periodoInicial, Date periodoFinal, Integer sequencia, String empresaAdquirente, TipoOpcaoExtratoDto opcaoExtrato,
			String van, String caixaPostal, String versaoLayout, String usoCielo) {
		super();
		this.tipoRegistro = tipoRegistro;
		this.estabelecimentoMatriz = estabelecimentoMatriz;
		this.dataProcessamento = dataProcessamento;
