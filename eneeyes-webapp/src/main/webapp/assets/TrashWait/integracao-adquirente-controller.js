app.controller('IntegracaoAdquirenteController', function ($scope, $filter, $timeout, IntegracaoAdquirente) {

	$scope.carregaListaHistorico = function() {
    	$scope.datas = new IntegracaoAdquirente.historicoIntegracao();
                ...
                for (var i = 0; i < files.length; i++) {
	            	...
	            	reader.onload = (function(theFile) {
	            		return function(e) {
	            			...
	            			if (lines[3] == undefined || lines[3].length > 298) {
...
//            				document.getElementById('infoFile').innerHTML = [lines[1]];
    ...
    $scope.uploadFile = function() {
    	if ($scope.noUpload) {
	        ...
	        xhr.open("POST", "/security/api/uploadDetalheVendaAdquirente");
