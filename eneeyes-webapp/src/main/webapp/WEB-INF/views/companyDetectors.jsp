							                	...
							                	<div ng-repeat="subItem in selectedCompanyDetector.detectorDto.sensorsDto">				                    			                    
								                	<div class="col-md-6">
								                    	<div class="description-block">
								                      		...
								                      		<span class="description-text">Min|Max: {{subItem.rangeMin}} | {{subItem.rangeMax}} - <u>{{subItem.unitMeterGases}}</u></span>
								                      		<h4>{{subItem.gasesDto[0].name}}</h4>
						               	...
						               	<div class="panel-body">
						                	...
						                	<div class="row">							                    				                    				                    
							                	<div ng-repeat="subItem in selectedCompanyDetector.detectorDto.sensorsDto">									                	
							                    	<div class="description-block">
							                      		<h5 class="description-header"> {{subItem.name}}</h5>
							                      		<span class="description-text">Min|Man: {{subItem.rangeMin}} | {{subItem.rangeMax} - <u>{{subItem.unitMeterGases}}</u>} </span>
							                      		<h4>{{subItem.gasesDto[0].name}}</h4>
								                	</div>									                    					                    
							                    </div>						                    					                    					                					                  			                  
							                </div>					                
