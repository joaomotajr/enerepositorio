...
public class HistoricoVendaRedeDto {
	...
	public HistoricoVendaRedeDto() {
	}
	
	public HistoricoVendaRedeDto(Long id, Integer estabelecimentoMatriz, Date dataProcessamento, Date periodoInicial,
