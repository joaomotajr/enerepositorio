								...
								<ul class="wizard_steps anchor">
									...
									<li>
										<a href="#step-3" class="disabled" data-ng-class="(selectedArea) ? 'selected' : 'disabled'" rel="3">
											...
											<span class="step_descr">Selecione �rea</span>
										</a>
									</li>
									<li>
							...
							<div class="row">
								...
								<div class="col-md-4">																															
									<div class="col-md-3" style="padding-right: 2px !important;">	
										<label style="margin-top: 5px !important;" title="Mostrando M�ximo e M��nimo"><span class="icon fa fa-object-group"></span> Agrupar</label>
									</div>
								...
								<div class="col-md-5" >									
									<div class="col-md-3">
										<label style="margin-top: 2px !important; padding-right: 5px !important;" title="Mostrando M�ximo e M�nimo"><span class="icon fa fa-caret"></span>Exibir/Exportar</label>
									</div>										        	
									<div class="form-group">
