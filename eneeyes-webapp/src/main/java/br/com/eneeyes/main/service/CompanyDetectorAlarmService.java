...
//		if (companyDetectorAlarmRepository.updateAlarm(companyDetectorAlarm.getAlarm(), companyDetectorAlarm.getCompanyDetector())  <= 0) {
...
//			positionService.updatePositionAlarmType(AlarmType.NORMAL, dto.getCompanyDetectorDto().getUid());
//		}
//		
...
//		companyDetectorAlarmRepository.deleteAlarm( companyDetectorAlarm.getCompanyDetector().getUid());
//		
////		positionService.updatePositionAlarmType(AlarmType.WITHOUT, dto.getCompanyDetectorDto().getUid(), dto.getSensorId());
//		positionService.updatePositionAlarmType(AlarmType.WITHOUT, dto.getCompanyDetectorDto().getUid());
//		
//		result.setResultType( ResultMessageType.SUCCESS );
...
//				dto.add(new CompanyDetectorAlarmDto(companyDetectorAlarm.getAlarm()));
//			}
//							
//			result.setList(dto);
//			result.setResultType( ResultMessageType.SUCCESS );
...
//					dto.add(new CompanyDetectorAlarmDto(companyDetectorAlarm.getAlarm(), companyDetectorDto));
//				}
//								
//				result.setList(dto);
//				result.setResultType( ResultMessageType.SUCCESS );
...
//	}
//	
//	public CompanyDetectorAlarmDto findByCompanyDetector(long companyDetectorUid, long sensorUid) {
//			
...
//		CompanyDetectorAlarm companyDetectorAlarm = companyDetectorAlarmRepository.FindByCompanyDetectorId(companyDetectorUid);
//		
...
//		return(companyDetectorAlarm == null ? null : new CompanyDetectorAlarmDto(companyDetectorAlarm.getAlarm()));
//		
//	}
//	
