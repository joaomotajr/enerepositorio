			                ...
			                <div class="row">
			                 	<div class="col-md-6">                                                                                                                            
									<div class="form-group">
								        ...
								        <span  data-ng-show="controllerForm.controllerName.$error.maxlength">Até Máximo 20 caracteres</span>                                                                        
								...
								<div class="col-md-6">
									<div class="form-group">
								        ...
								        <span  data-ng-show="controllerForm.controllerModel.$error.maxlength">Até Máximo 20 caracteres</span>                                                       
