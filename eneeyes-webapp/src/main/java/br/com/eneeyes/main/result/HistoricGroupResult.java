...
public class HistoricGroupResult<T> extends BasicResult<T> {
	
	private List<IHistoricGroup> list;	
	...
	public List<IHistoricGroup> getList() {
		return list;
	}

	public void setList(List<IHistoricGroup> resultList) {
