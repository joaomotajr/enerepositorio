					...
					<div class="modal-body">
									...
									<div class="row">											
										<div class="col-md-6">
											<div class="box box-primary box-solid">				                    
							                	<div class="box-header with-border"><strong><i class="fa fa-info"></i> Nome</strong></div>
							                    <div class="box-body">												                                                                                                                
				  	...
				  	<div class="modal-footer">						
						...
						<button type="button" data-ng-click="saveAlarm();" class="btn btn-primary" data-dismiss="modal"
							data-ng-disabled="(alarmName && alarmGas && gasUnitMeterGases && alarmAlarm1 && alarmAlarm2 && alarmAlarm3 && company) ? false : true">Salvar
						</button>						                                
				  	</div>
			  	</div>
			</div>		
