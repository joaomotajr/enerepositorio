...
@XmlRootElement
public class DetalheVendaCieloResult extends ResultBase<DetalheVendaDto> {
    
	DetalheVendaDto value;
	VendaManualDto valueManual;
	List<DetalheVendaDto> listValue;

    public DetalheVendaCieloResult() {
    }

    public DetalheVendaCieloResult(DetalheVendaDto value) {
        this.value = value;
    }
