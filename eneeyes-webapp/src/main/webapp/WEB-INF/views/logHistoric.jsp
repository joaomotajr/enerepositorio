						...
						<div class="box-body" style="padding-bottom: 0px !important">	
							...
							<div class="row">
								<form class="form" name="userForm">						 		
									...
									<div class="col-md-4">
										<div class="form-group">
											<label class="control-label">Buscar por Intervalos Pr�-Definidos: </label> <br />								
							...
							<div class="row">
											...
											<tbody>		
												...
												<tr data-ng-repeat="item in listHistoricInterval.list | alarmFilter:selectedfilterAlarm">	
													...
													<td>
														...
														<span data-ng-if="item.logOrigem == 'MANUAL'">�AN�LISE DE CEN�RIO�</span>
								...
								<div class="col-md-3">
									...
									<div class="row" style=" vertical-align: middle; text-align: center;">									
										<label><span class="icon fa fa-columns"> Itens por P�gina:</span><span class="text-red" data-ng-show="!lenPageValid"> [0 - 2000]</span></label>
									</div>
									...
									<div style="vertical-align: middle; text-align: center; font-size: 05.em">
										<label data-ng-show='countHistoric > 0'> P�ginas: {{countPages}}</label>
									</div>
									</div>							
			...
			<div id="dvData">
				<table class='zui-table' data-cellspacing="0" data-width="100%">	                   
					<tr>	                
							...
							<th data-ng-if="tipoGrupo==1">Origem Informa��o</th>			                                                                                                                            
						</tr>                                    
						<tr data-ng-repeat="item in listHistoricInterval.list | alarmFilter:selectedfilterAlarm">
							<td>{{item.sensorId}} </td>
							<td>{{item.lastUpdate | date:'dd/MM/yyyy' }}</td>
