...
import br.com.eneeyes.main.service.historic.exunion.HistoricViewService;
...
public class HistoricViewController {
	...
	@RequestMapping(value="/security/api/historicView/findByCompanyDeviceAndInterval/{companyDeviceId}/{intervalType}/{currentPage}/{lenPage}", 
	...
	@RequestMapping(value="/security/api/historicView/findByCompanyDeviceAndIntervalDays/{companyDeviceId}/{dateIn}/{dateOut}/{currentPage}/{lenPage}", method=RequestMethod.GET, produces = "application/json")			
	@ResponseStatus(HttpStatus.OK)
	public GroupResult<?> findByCompanyDeviceAndIntervalDays(
			@PathVariable Long companyDeviceId, 
