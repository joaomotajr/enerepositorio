	<div data-ng-controller="UserPerfilController as UserPerfilController" style="background: Gainsboro">
		<br>					 
		<div class="row">
			<div class="col-md-2">
			</div>				                                                    
			<div class="col-md-8">		 
				...
				<div class="box box-primary" style="padding-bottom: 0px; !important; margin-bottom: 0px !important;">
					...
					<div class="box-body" style="padding-bottom: 0px; !important">
						...
						<form class="form" name="userForm" novalidate>
							...
							<div class="row">							
								...
								<div class="col-md-4">
									<div class="box box-primary">
										<div class="box-header with-border"><strong>Login *</strong>
							...
							<div class="row">
								...
								<div class="col-md-3">					
									<label class="control-label" title="Status do Usuário" title="Será Preciso Logar Novamente">Trocar a Senha <span class="text=muted" style="display: font-size: 60%"> (Precisa Logar Novamente)</span></label>
									<div class="input-group">	
										<button type="button" title="Resetar a Senha, Será Preciso Logar Novamente" data-ng-click="userPerfil.reset=true" class="btn btn-primary" data-ng-if="!userPerfil.reset"><i class="fa fa-user"> </i>  RESET  </button>
										<button type="button" title="Clique Para Cancelar o Reset" data-ng-click="userPerfil.reset=false;" class="btn btn-danger" data-ng-if="userPerfil.reset==true"><i class="fa fa-user-times"> </i>RESETADA</button>
									</div>							
								</div>
					...
					<div class="modal-footer">						
						<button type="button" class="btn btn-default" data-ng-click="selfClose();" >Cancelar</button>							                                                                
						<button type="button" data-ng-click="saveUser();" class="btn btn-primary" data-ng-disabled="(loginValid && emailValid && userForm.$valid) ? false : true">Salvar</button>				
					</div>
				</div>
			</div>
			<div class="col-md-2">
