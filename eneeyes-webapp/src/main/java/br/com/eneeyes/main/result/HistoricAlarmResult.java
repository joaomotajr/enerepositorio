...
public class HistoricAlarmResult<T> extends BasicResult<T> {
	
	private List<HistoricAlarm> list;	
	...
	public List<HistoricAlarm> getList() {
		return list;
	}

	public void setList(List<HistoricAlarm> resultList) {
