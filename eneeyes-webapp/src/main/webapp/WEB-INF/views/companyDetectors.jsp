			...
			<div class="box-body">
				...
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs tabDetector">
				       	...
				       	<li><a href="#tabCompanyDetector_4" id="stepTabDetector_4" data-toggle="tab">Manuten��o/Instala��o </a></li>
				       	<li><a href="#tabCompanyDetector_2" id="stepTabDetector_2" data-toggle="tab">Configura��o</a></li>
				       	<li><a href="#tabCompanyDetector_3" id="stepTabDetector_3" data-toggle="tab">Gr�fico do Hist�rico</a></li>				       	
				    		...
				    		<div class="row">
					    		...
					    		<form name="userForm">					    		
						    		...
						    		<div class="row">				    			
								        ...
								        <div class="col-md-2">
								            <div class="form-group">								            
								                <label class="control-label">Identifica��o</label>
								                <span class="text-red" data-ng-show="userForm.username.$error.required && !userForm.username.$pristine">  [Identifica��o Obrigatorio]</span>
									            <span class="text-red" data-ng-show="userForm.username.$error.maxlength">Tamanho M�ximo 8 caracteres</span>
								                <input data-disallow-spaces id="companyDetectorName" class="form-control" style="text-transform:uppercase" 
								                	placeholder="Identifica��o do Detector (Sem Espa�os)" 
								                	data-ng-model="selectedCompanyDetector.name" data-ng-maxlength="8" name="username" 
								                	title="Identifica��o do Detector (Sem Espa�os)"
								                required>
								            </div>
								        </div>
								        ...
								        <div class="col-md-2">
								        	<div class="form-group">
								                <label class="control-label">Nr. de S�rie</label>
								                <input class="form-control" placeholder="Nro de S�rie do Detector" data-ng-maxlength="24" 
								        ...
								        <div class="col-md-6">
								            <div class="form-group">
								                ...
								                <input class="form-control" placeholder="Descri��o" data-ng-model="selectedCompanyDetector.description">
								            </div>
								        </div>
								    </div>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<label class="control-label">Identifica��o do Detector/Sensores</label>
					              	...
					              	<div class="panel panel-primary">						                
						                <div class="panel-heading">
						               	...
						               	<div class="panel-body">
											...
											<label data-ng-hide="changeGraphic" class="pull-right">Gr�fico Medi��es&nbsp;&nbsp;</label>
						               	...
						               	<div class="panel-body">
						               		<form name="userFormMaintance">
						               			<div class="row">				    			
									                	...
									                	<div class="form-group">
															...
															<div class="input-group">                                                            
																<div class="input-group-addon">
																	...
																	<i class="fa fa-calendar-times-o" style="color:red" data-ng-show='deliveryDateValid' title="Data Inv�lida"></i>                                                                 
																</div>
											        ...
											        <div class="col-md-6">
											            <div class="form-group">
											                ...
											                <input class="form-control" placeholder="Descri��o" data-ng-model="selectedCompanyDetector.descriptionDelivery">
											            </div>
											        </div>
											    </div>						               		
											    ...
											    <div class="row">				    			
											        <div class="col-md-3">											        	
									                	<div class="form-group">
															<label>Data de Instala��o:</label>
															<div class="input-group">                                                            
																<div class="input-group-addon">
																	<i class="fa fa-calendar" data-ng-hide='installDateValid'></i>
																	<i class="fa fa-calendar-times-o" style="color:red" data-ng-show='installDateValid' title="Data Inv�lida"></i>                                                                 
																</div>
											        ...
											        <div class="col-md-3">
											            <div class="form-group">								            
											                <label class="control-label">Manuten��o: <span style="font-size: 80%">(Dias)</span></label>
											                
											                <input class="form-control" type="number"
											                	placeholder="Dias" 
											                	data-ng-model="selectedCompanyDetector.maintenanceInterval" name="maintenanceInterval" 
											                	title="Intervalo Recomendado de Manuten��o/Calibra��o."
											                required>
											            </div>
											        </div>
											        ...
											        <div class="col-md-6">
											            <div class="form-group">
											                <label class="control-label">Detalhes Sobre a Instala��o:</label>
											                <input class="form-control" placeholder="Descri��o" data-ng-model="selectedCompanyDetector.descriptionInstall">
											            </div>
											        </div>
											    </div>
				...
				<div class="modal-content">                            
					<div class="modal-body">
						<div class="panel panel-default">
							<div class="panel-heading" style="text-align:center">Selecione Alarme para o Sensor: <strong> {{selectedSensor.name}} </strong> - Valor M�ximo: <strong>{{selectedSensor.rangeMax}}</strong> </div>                                                                           
					  	</div>
