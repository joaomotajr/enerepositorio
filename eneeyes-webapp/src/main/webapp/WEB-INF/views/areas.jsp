		...
		<div class="box-body">		
			...
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs tabArea">
			    	...
			    	<li title="Trocar Imagem da ÔøΩrea" class="pull-right"><a href="#" id="idBtnChooseFileArea"><i class="fa fa-file-image-o"></i></a></li>			    	
			    </ul>
			    		...
			    		<div class="row">
					        ...
					        <div class="col-md-6">
					            <div class="form-group">
					                ...
					                <input class="form-control" placeholder="DescriÔøΩÔøΩo" ng-model="selectedArea.description">
					            </div>
					        </div>
					    </div>
						...
						<div class="row">
					        ...
					        <div class="col-md-4">
				                ...
				                <div class="form-group">				                 	
				                 	...
				                 	<label><input type="radio" ng-model="selectedArea.classified" value="0" />&nbsp; N„o</label>						                
				                </div>
