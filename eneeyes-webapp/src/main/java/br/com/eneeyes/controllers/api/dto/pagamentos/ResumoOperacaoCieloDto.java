...
public class ResumoOperacaoCieloDto implements Serializable, Comparable<ResumoOperacaoCieloDto> {
	...
	public ResumoOperacaoCieloDto() {
	}
	
	public ResumoOperacaoCieloDto(Long id, Integer estabelecimentoSubmissor, Integer numeroRO,
			...
			CodigoProdutoDto identificadorProduto, String usoCielo) {
		super();
		this.id = id;
	...
	@Override
	public int compareTo(ResumoOperacaoCieloDto o) {
