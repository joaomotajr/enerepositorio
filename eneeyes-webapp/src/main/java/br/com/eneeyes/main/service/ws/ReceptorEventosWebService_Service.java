...
@WebServiceClient(name = "ReceptorEventosWebService", 
                  wsdlLocation = "http://qa.segware.com.br:5050/SigmaWebServices/ReceptorEventosWebService?wsdl",
...
public class ReceptorEventosWebService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://qa.segware.com.br:5050/SigmaWebServices/ReceptorEventosWebService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ReceptorEventosWebService_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://qa.segware.com.br:5050/SigmaWebServices/ReceptorEventosWebService?wsdl");
        }
        WSDL_LOCATION = url;
    }
