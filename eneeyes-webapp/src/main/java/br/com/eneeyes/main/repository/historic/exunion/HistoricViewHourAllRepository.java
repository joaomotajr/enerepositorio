...
import br.com.eneeyes.main.model.historic.exunion.HistoricViewHourAll;
...
public interface HistoricViewHourAllRepository extends JpaRepository<HistoricViewHourAll, Long> {
	...
	@Query("select h from HistoricViewHourAll h where h.companyDeviceId in ?1 and h.lastUpdate between ?2 and ?3")
