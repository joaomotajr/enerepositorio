...
app.controller('companyDetectorController', function ($scope, $interval, $rootScope, $timeout, $filter, AlarmService,
	...
	$scope.getOneCompanyDetector = function() {
		...
		$scope.resultCompanyDetector.$companyDetector({_csrf : angular.element('#_csrf').val(), id : $scope.selectedCompanyDevice.uid }, function(){			
			...
			if($scope.selectedCompanyDetector != null) {
				...
				// if ($scope.selectedCompanyDetector.alarmDto) {
				// 	$scope.selectedCompanyDetectorAlarm = $scope.selectedCompanyDetector.alarmDto;
				// 	$scope.selectedCompanyDetectorAlarm.rangeMax = $scope.selectedCompanyDetector.detectorDto.sensorDto.rangeMax;
				// 	$scope.selectedCompanyDetectorAlarm.rangeMin = $scope.selectedCompanyDetector.detectorDto.sensorDto.rangeMin;
				// 	$scope.selectedCompanyDetectorAlarm.sensorName = $scope.selectedCompanyDetector.detectorDto.sensorDto.name;
				// 	$scope.selectedCompanyDetectorAlarm.companyDetectorName = $scope.selectedCompanyDetector.name;
	...
	$scope.getPositionsAndIds = function(companyDetectorId) {
		...
		$scope.listOnePositionNoTimer.$position({_csrf : angular.element('#_csrf').val(), id : companyDetectorId}, function() { 
			...
			// $scope.selectedCompanyDetectorAlarm.lastValue = $scope.listOnePosition.t.lastValue;
			// $scope.selectedCompanyDetectorAlarm.lastUpdate = $scope.listOnePosition.t.lastUpdate;
			// $scope.selectedCompanyDetectorAlarm.alarmType = $scope.listOnePosition.t.alarmType;	

			// $scope.selectedCompanyDetectorAlarm.dataSource = $scope.getGaugeInfo($scope.selectedCompanyDetectorAlarm);
	...
	// $scope.getCompanyDetectorAlarm = function() {
	...
	$scope.configAlarm = function(index) {
		...
		$scope.search = { unitMeterGases: $scope.selectedCompanyDetectorAlarm.unitMeterGases, gas : $scope.selectedCompanyDetectorAlarm.gasDto.name};
	...
	if($scope.$root.selecteds.unitIndex != undefined) {
		...
		$scope.selectedCompanyDetectorAlarm = [];
		$scope.getDetectors();
		$scope.getAlarms();		
	}
